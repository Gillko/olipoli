...
(function(l) {
	...
	t.prototype = {
		...
		_x3: function(b, f, c, h, a) {
			...
			d._e ? d._l ? (d._c = parseInt(d._c), c = d._g + d._v1, k[d._g + d._u1] = d._c + "ms", k[c] = h ? l.rsCSS3Easing[d.st.easeInOut] : l.rsCSS3Easing[d.st.easeOut], d._p1.css(k), h || !d.hasTouch ? setTimeout(function() {
				d._p3(b)
			...
			}, d._c + 60)), k.display = "block", k.zIndex = d._m, k.opacity = 0, k[d._g + d._u1] = "0ms", k[d._g + d._v1] = l.rsCSS3Easing[d.st.easeInOut], g.css(k), g.data("rsTimeout", setTimeout(function() {
...
(function(b) {
	b.extend(b.rsProto, {
		...
		_e5: function() {
			!this._g5 && !this._f5 && (this._h5 = !1, this._i5 && (clearTimeout(this._i5), this._i5 = null))
		}
	});
...
(function(f) {
	f.extend(f.rsProto, {
		...
		_l6: function() {
			...
			for (var j = 0; j < a.numSlides; j++) d = a.slides[j], b += "<div" + g + ' class="rsNavItem rsThumb">' + d.thumbnail + a._p6 + "</div>";
			b = f(b + "</div></div>");
			g = {};
...
(function(f) {
	f.extend(f.rsProto, {
		_a7: function() {
			...
			a.st.video = f.extend({}, a._b7, a.st.video);
			a.ev.on("rsBeforeSizeSet", function() {
		...
		playVideo: function() {
			...
			if (!a._c7) {
				...
				var b = a._e7 = c.content,
					c = c.videoURL,
					e, d;
				c.match(/youtu\.be/i) || c.match(/youtube\.com/i) ? (d = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/, (d = c.match(d)) && 11 == d[7].length && (e = d[7]), void 0 !== e && (a._d7 = a.st.video.youTubeCode.replace("%id%", e))) : c.match(/vimeo\.com/i) && (d = /(www\.)?vimeo.com\/(\d+)($|\/)/, (d = c.match(d)) && (e = d[2]), void 0 !== e && (a._d7 = a.st.video.vimeoCode.replace("%id%", e)));
				a.videoObj = f(a._d7);
