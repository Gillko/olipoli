...
.controller('mainCtrl', function($scope, $http){
	...
	$http.get('http://localhost:8888/olipoli/version1-laravel/public/listitems_json')
		.then(function(res){
			$scope.listitems = res.data;
		});

	//$http.get('http://localhost:8888/public/pictures_json')
	$http.get('http://localhost:8888/olipoli/version1-laravel/public/pictures_json')
		.then(function(res){
			$scope.pictures = res.data;
		});

	//$http.get('http://localhost:8888/public/contents_json')
	$http.get('http://localhost:8888/olipoli/version1-laravel/public/contents_json')
		.then(function(res){
			$scope.contents = res.data;
		});

	//$http.get('http://localhost:8888/public/contacts_json')
	$http.get('http://localhost:8888/olipoli/version1-laravel/public/contacts_json')
		.then(function(res){
			$scope.contacts = res.data;
		});

	//$http.get('http://localhost:8888/public/packages_json')
	$http.get('http://localhost:8888/olipoli/version1-laravel/public/packages_json')
		.then(function(res){
